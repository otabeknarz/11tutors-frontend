...
import { ArrowRightIcon, BookOpenIcon, UsersIcon, GraduationCapIcon } from 'lucide-react';
...
export default function CtaBanner() {
  ...
  // Stats to display
  const stats = [
    { icon: BookOpenIcon, value: '500+', label: t('landing.ctaBanner.stats.courses') },
    { icon: UsersIcon, value: '50,000+', label: t('landing.ctaBanner.stats.students') },
    { icon: GraduationCapIcon, value: '2,000+', label: t('landing.ctaBanner.stats.tutors') }
  ];
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 mb-12">
            <div className="md:max-w-lg">
              ...
              >
                ...
                {t('landing.ctaBanner.discount')} <span className="font-bold text-white">{t('landing.ctaBanner.discountCode')}</span>
              </motion.p>
              ...
              >
                ...
                <Button 
                  ...
                  className="rounded-full shadow-lg"
                >
                  <Link href="/become-tutor">{t('landing.ctaBanner.becomeTutor')}</Link>
                </Button>
              </motion.div>
            </div>
            ...
            >
              <div className="text-center mb-4">
                <h3 className="font-bold text-white text-xl">{t('landing.ctaBanner.stats.title')}</h3>
              </div>
