...
const mockCourses: CourseCategories = {
	"computer-science": [
		{
			...
			description:
				"Learn Python fundamentals from scratch with practical projects.",
			icon: Code,
	...
	mathematics: [
		...
		},
		{
			...
			description:
				"Vector spaces, matrices, and linear transformations explained.",
			icon: LineChart,
	...
	business: [
		...
		},
		{
			...
			description:
				"Master the fundamentals of accounting and financial statements.",
				...
				>
					...
					>
						<TabsList className="grid grid-cols-3 w-full max-w-md">
							<TabsTrigger value="computer-science">
								{categoryLabels.computerScience}
							</TabsTrigger>
							<TabsTrigger value="mathematics">
								{categoryLabels.mathematics}
							</TabsTrigger>
					...
					{Object.keys(mockCourses).map((category) => (
						<TabsContent key={category} value={category} className="mt-0">
							...
							>
								{mockCourses[category as keyof CourseCategories].map(
									(course) => (
	...
	return (
		<Card className="overflow-hidden h-full group">
			<div className="aspect-video relative overflow-hidden">
				...
				<div
					className={`absolute inset-0 ${course.iconBgClass} flex items-center justify-center`}
				>
			...
			<CardContent>
				...
				<div className="flex items-center gap-2 mt-4 text-sm">
					...
					<span className="text-muted-foreground">
						{t("landing.featuredCourses.courseCard.courseBy")}
					</span>
			...
			<CardFooter className="flex items-center justify-between pt-4 border-t">
				<div className="font-bold text-lg">
					<span className="text-sm text-muted-foreground mr-1">
						{t("landing.featuredCourses.courseCard.price")}
					</span>
