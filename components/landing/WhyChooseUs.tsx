...
export default function WhyChooseUs(props: WhyChooseUsProps) {
  ...
  const benefits = props.benefits && props.benefits.length > 0 ? props.benefits : [];
  ...
  const universities = [
    { name: 'Harvard University', initial: 'H', color: 'bg-crimson-700' },
  ...
  // Stats
  const stats = [
    { value: t('landing.whyChooseUs.stat1.value'), label: t('landing.whyChooseUs.stat1.label'), icon: StarIcon, color: 'bg-amber-100 text-amber-700' },
    { value: t('landing.whyChooseUs.stat2.value'), label: t('landing.whyChooseUs.stat2.label'), icon: AwardIcon, color: 'bg-blue-100 text-blue-700' },
    { value: t('landing.whyChooseUs.stat3.value'), label: t('landing.whyChooseUs.stat3.label'), icon: HeartIcon, color: 'bg-red-100 text-red-700' },
    { value: t('landing.whyChooseUs.stat4.value'), label: t('landing.whyChooseUs.stat4.label'), icon: ShieldCheckIcon, color: 'bg-green-100 text-green-700' }
  ];
              ...
              >
                <Card className="border-none shadow-md overflow-hidden h-full">
                  <CardContent className="p-6 text-center">
                    <div className={`mx-auto w-12 h-12 rounded-full ${stat.color} flex items-center justify-center mb-4`}>
              ...
              >
                <Card className="overflow-hidden h-full border-none shadow-md">
                  ...
                  <CardContent className="p-6">
                    <div className={`mb-4 w-14 h-14 rounded-full bg-gradient-to-br ${benefit.color} flex items-center justify-center text-white shadow-md`}>
                      <Icon className="h-7 w-7" />
                    </div>
                    <h3 className="text-xl font-semibold mb-2 flex items-center gap-2">
                      {benefit.emoji && <span className="text-xl">{benefit.emoji}</span>}
        ...
        >
          ...
          >
            {universities.map((university, index) => (
              ...
              >
                <div className={`w-12 h-12 ${university.color} rounded-full flex items-center justify-center text-white font-bold text-lg shadow-md`}>
                  {university.initial}
                </div>
                <span className="text-xs mt-2 text-muted-foreground">{university.name}</span>
              </motion.div>
            ))}
          </motion.div>
