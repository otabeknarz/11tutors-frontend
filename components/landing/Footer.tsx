...
export default function Footer() {
  ...
  const socialLinks = [
    { name: t('landing.footer.social.instagram'), icon: InstagramIcon, href: 'https://instagram.com/11tutors', color: 'bg-gradient-to-br from-pink-500 to-purple-500' },
    { name: t('landing.footer.social.twitter'), icon: TwitterIcon, href: 'https://twitter.com/11tutors', color: 'bg-blue-500' },
    { name: t('landing.footer.social.youtube'), icon: YoutubeIcon, href: 'https://youtube.com/11tutors', color: 'bg-red-600' },
    { name: t('landing.footer.social.linkedin'), icon: LinkedinIcon, href: 'https://linkedin.com/company/11tutors', color: 'bg-blue-700' },
    { name: t('landing.footer.social.facebook'), icon: FacebookIcon, href: 'https://facebook.com/11tutors', color: 'bg-blue-600' },
  ];
  ...
  const footerLinks = {
    ...
    resources: [
      ...
      { name: t('landing.footer.links.becomeTutor'), href: '/become-tutor' },
    ],
    legal: [
      { name: t('landing.footer.links.termsOfService'), href: '/terms' },
      { name: t('landing.footer.links.privacyPolicy'), href: '/privacy' },
      { name: t('landing.footer.links.cookiePolicy'), href: '/cookies' },
      { name: t('landing.footer.links.accessibility'), href: '/accessibility' },
    ],
    categories: [
      { name: t('landing.footer.links.computerScience'), href: '/courses/computer-science' },
      { name: t('landing.footer.links.mathematics'), href: '/courses/mathematics' },
      ...
      { name: t('landing.footer.links.artsHumanities'), href: '/courses/arts-humanities' },
    ],
  };
    ...
    <footer className="pt-16 pb-8 relative overflow-hidden" ref={footerRef}>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            &copy; {currentYear} 11Tutors. {t('landing.footer.allRightsReserved')}
          </motion.p>
          <motion.p 
            variants={itemVariants}
