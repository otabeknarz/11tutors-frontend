    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          >
            <option value="">{t('onboarding.degree.placeholder')}</option>
            {DEGREES.map((deg) => (
        ...
        {degree === 'Other' && (
          <div>
            <label htmlFor="otherDegree" className="block text-sm font-medium text-gray-700 mb-1">
              {t('onboarding.degree.other')}
            </label>
            <input
              type="text"
              id="otherDegree"
